...
-- ============================================================
--  FILE 1: DDL + DML + SQL Queries
--  NOTE: Written for MySQL 8.0 syntax.
--        Run in MySQL Workbench or MySQL CLI.
--        CREATE DATABASE hms_db; USE hms_db;  -- run first
-- ============================================================
...
-- Patients
INSERT INTO Patient (full_name, dob, gender, phone, address, blood_group, reg_date) VALUES
('Aarav Sharma',    '1990-03-15', 'M', '9876543210', 'Ludhiana, Punjab',   'O+',  '2024-01-10'),
('Priya Mehta',     '1985-07-22', 'F', '9876543211', 'Chandigarh',         'A+',  '2024-02-05'),
('Rohan Singh',     '2000-11-01', 'M', '9876543212', 'Amritsar, Punjab',   'B+',  '2024-02-18'),
('Sneha Kapoor',    '1995-05-30', 'F', '9876543213', 'Delhi',              'AB-', '2024-03-01'),
('Vikram Joshi',    '1978-09-09', 'M', '9876543214', 'Jalandhar, Punjab',  'O-',  '2024-03-15'),
('Ananya Gupta',    '2003-01-20', 'F', '9876543215', 'Patiala, Punjab',    'A-',  '2024-04-02'),
('Manish Verma',    '1988-06-11', 'M', '9876543216', 'Ludhiana, Punjab',   'B-',  '2024-04-20'),
('Kavya Nair',      '1992-12-25', 'F', '9876543217', 'Mumbai',             'AB+', '2024-05-05');

-- Doctors
INSERT INTO Doctor (full_name, specialization, phone, email, salary, joining_date) VALUES
('Dr. Ramesh Kumar',  'Cardiology',       '9111111101', 'ramesh@hms.com',  120000.00, '2018-06-01'),
('Dr. Sunita Rao',    'Neurology',        '9111111102', 'sunita@hms.com',  130000.00, '2019-03-15'),
('Dr. Anil Patel',    'Orthopedics',      '9111111103', 'anil@hms.com',    110000.00, '2020-01-10'),
('Dr. Meena Khanna',  'General Medicine', '9111111104', 'meena@hms.com',    90000.00, '2021-07-20'),
('Dr. Suresh Iyer',   'Dermatology',      '9111111105', 'suresh@hms.com',   95000.00, '2022-02-28');

-- Appointments
INSERT INTO Appointment (patient_id, doctor_id, appt_date, appt_time, status) VALUES
(1, 1, '2024-06-01', '10:00:00', 'Completed'),
(2, 2, '2024-06-03', '11:30:00', 'Completed'),
(3, 3, '2024-06-05', '09:00:00', 'Completed'),
(4, 4, '2024-06-07', '14:00:00', 'Completed'),
(5, 1, '2024-06-10', '10:30:00', 'Completed'),
(6, 5, '2024-06-12', '15:00:00', 'Scheduled'),
(7, 2, '2024-06-15', '11:00:00', 'Cancelled'),
(8, 4, '2024-06-18', '09:30:00', 'Completed');
...
(1, 1, 1500.00, 'Paid',    '2024-06-01'),
(2, 2, 2000.00, 'Paid',    '2024-06-03'),
(3, 3, 1200.00, 'Paid',    '2024-06-05'),
(4, 4,  800.00, 'Pending', '2024-06-07'),
(5, 5, 1800.00, 'Paid',    '2024-06-10'),
(8, 8,  950.00, 'Pending', '2024-06-18');
